...
# Make autogenerated Proxy classes read-only
echo '> Make autogenerated Proxy classes read-only'
docker-compose exec app sh -c 'chmod a=rX /var/www/var/cache/dev/ezplatform_workflow/proxy/'
