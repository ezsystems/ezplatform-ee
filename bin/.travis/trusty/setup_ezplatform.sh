...
# TMP - should fail
echo '> Make autogenerated Proxy directories read-only'
docker-compose exec app sh -c "chmod a=rX /var/www/var/cache/${APP_ENV}/repository/proxy/"
docker-compose exec app sh -c "chmod a=rX /var/www/var/cache/${APP_ENV}/ezplatform_workflow/proxy/"

echo '> Install data'
docker-compose exec --user www-data app sh -c "php /scripts/wait_for_db.php; composer ezplatform-install"

# Make autogenerated Proxy directories read-only
echo '> Make autogenerated Proxy directories read-only'
docker-compose exec app sh -c "chmod a=rX /var/www/var/cache/${APP_ENV}/repository/proxy/"
docker-compose exec app sh -c "chmod a=rX /var/www/var/cache/${APP_ENV}/ezplatform_workflow/proxy/"
